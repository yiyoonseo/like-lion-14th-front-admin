...
const Modal = ({ show, onClose }) => {
  ...
  return (
    ...
    >
      <div
        className="bg-gray-900 rounded-2xl overflow-hidden max-w-2xl w-full max-h-[90vh] shadow-2xl flex flex-col md:flex-row"
      ...
      >
        ...
        <img
          ...
          alt={show.name}
          className="w-full max-h-52 md:max-h-none p-2 rounded-xl md:w-64 object-cover flex-shrink-0"
        />
